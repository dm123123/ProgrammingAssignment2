...
## a matrix rather than compute it repeatedly when it is 
# not necessary. As when inverse of matrix has been computed
# and cached and then the inverse is asked and matrix 
# has not changed
